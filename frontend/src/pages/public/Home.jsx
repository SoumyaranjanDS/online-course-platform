...
import { BookOpen, Code2, Database, Layout, Shield, CreditCard, PlayCircle, Users } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Built with React 19, Vite, and the brand new Tailwind CSS v4 for blazing fast performance and modern styling.'
    },
    {
      icon: <Database className="w-6 h-6 text-emerald-500" />,
      title: 'Robust Backend',
      description: 'Powered by Node.js, Express, and MongoDB with a scalable, modular MVC architecture.'
    },
    {
      icon: <Shield className="w-6 h-6 text-purple-500" />,
      title: 'Secure Authentication',
      description: 'Role-based access control with JWT for Students, Instructors, and Administrators.'
    },
    {
      icon: <PlayCircle className="w-6 h-6 text-rose-500" />,
      title: 'Cloudinary Media',
      description: 'Secure, direct-to-cloud video and image uploading with signed URLs for course content.'
    },
    {
      icon: <CreditCard className="w-6 h-6 text-amber-500" />,
      title: 'Stripe Payments',
      description: 'Integrated Stripe Checkout for seamless course purchases and secure payment processing.'
    },
    {
      icon: <Users className="w-6 h-6 text-indigo-500" />,
      title: 'Multi-Role Platform',
      description: 'Instructors can create courses, students can learn, and admins manage the entire ecosystem.'
    }
  ];
    ...
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-blue-500 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/signup" className="text-sm font-medium bg-slate-900 text-white px-4 py-2 rounded-full hover:bg-slate-800 transition-all shadow-md hover:shadow-lg active:scale-95">
                Sign up
              </Link>
            </div>
          </div>
        ...
        <section className="relative pt-24 pb-32 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-xl text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed">
              A comprehensive Udemy-like clone boilerplate strictly built with JavaScript, React, Tailwind CSS v4, Express, and MongoDB. No TypeScript, no Redux, pure simplicity and power.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/courses" className="px-8 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-full hover:shadow-lg hover:shadow-blue-500/30 transition-all active:scale-95 flex items-center gap-2">
                Explore Courses
              </Link>
              <a href="#tech-stack" className="px-8 py-3.5 bg-white text-slate-700 font-medium rounded-full border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all active:scale-95">
                View Tech Stack
              </a>
            </div>
          </div>
        ...
        <section id="tech-stack" className="py-24 bg-white border-y border-slate-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-slate-900">Project Architecture & Features</h2>
              <p className="mt-4 text-slate-600 max-w-2xl mx-auto">
                Everything you need to build a scalable, multi-role online course platform, set up and ready for business logic implementation.
              </p>
            </div>
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-slate-300 mb-10 text-lg">
              The boilerplate is fully set up. Check the <code>docs/</code> folder for the API flows, project structure, and environment variable requirements.
            </p>
      ...
      <footer className="bg-slate-950 py-8 border-t border-white/10 text-center">
        <p className="text-slate-500 text-sm">
          &copy; {new Date().getFullYear()} LearnHub. Built for the Online Course Platform Project.
        </p>
      </footer>
    </div>
  );
